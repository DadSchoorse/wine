...
{
    struct wine_vk_driver_surface_base base;
    LONG ref;
    Window window;
};
        ...
        const VkAllocationCallbacks *allocator, VkSwapchainKHR *swapchain)
{
    ...
    create_info_host.surface = surface_from_handle(create_info->surface)->base.surface;
        ...
        const VkAllocationCallbacks *allocator, VkSurfaceKHR *surface)
{
    ...
    res = pvkCreateXlibSurfaceKHR(instance, &create_info_host, NULL /* allocator */, &x11_surface->base.surface);
    if (res != VK_SUCCESS)
    {
        ...
        const VkAllocationCallbacks *allocator)
{
    ...
    if (x11_surface)
    {
        pvkDestroySurfaceKHR(instance, x11_surface->base.surface, NULL /* allocator */);
        ...
        VkSurfaceKHR surface, VkDeviceGroupPresentModeFlagsKHR *flags)
{
    ...
    return pvkGetDeviceGroupSurfacePresentModesKHR(device, x11_surface->base.surface, flags);
}
        ...
        VkSurfaceKHR surface, uint32_t *count, VkRect2D *rects)
{
    ...
    return pvkGetPhysicalDevicePresentRectanglesKHR(phys_dev, x11_surface->base.surface, count, rects);
}
        ...
        const VkPhysicalDeviceSurfaceInfo2KHR *surface_info, VkSurfaceCapabilities2KHR *capabilities)
{
    ...
    surface_info_host.surface = surface_from_handle(surface_info->surface)->base.surface;
        ...
        VkSurfaceKHR surface, VkSurfaceCapabilitiesKHR *capabilities)
{
    ...
    return pvkGetPhysicalDeviceSurfaceCapabilitiesKHR(phys_dev, x11_surface->base.surface, capabilities);
}
        ...
        VkSurfaceKHR surface, uint32_t *count, VkSurfaceFormatKHR *formats)
{
    ...
    return pvkGetPhysicalDeviceSurfaceFormatsKHR(phys_dev, x11_surface->base.surface, count, formats);
}
        ...
        VkSurfaceKHR surface, uint32_t *count, VkPresentModeKHR *modes)
{
    ...
    return pvkGetPhysicalDeviceSurfacePresentModesKHR(phys_dev, x11_surface->base.surface, count, modes);
}
        ...
        uint32_t index, VkSurfaceKHR surface, VkBool32 *supported)
{
    ...
    return pvkGetPhysicalDeviceSurfaceSupportKHR(phys_dev, index, x11_surface->base.surface, supported);
}
